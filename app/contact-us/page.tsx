...
const ConactUsPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Send data to both the database and SMS endpoints
      // const [dbResponse, smsResponse] = await Promise.all([
      ...
      // Send data to both the database and SMS endpoints
      //if (dbResponse.ok && smsResponse.ok) {
      if (dbResponse.ok) {
      ...
      <div className="container px-6 py-12 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-6">
          <div className="lg:w-1/2 lg:mx-6">
            ...
            <div className="mt-6 space-y-8 md:mt-8">
                    <p className="flex items-start -mx-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-[#219ebc]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>

                        <span className="mx-2 text-black truncate w-72">
                            1580 Leucadia Blvd, Encinitas, CA 92024
                        </span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-black truncate w-72">(760) 402-8146</span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-black truncate w-72">LPDAutoDetail@gmail.com</span>
                    </p>
                </div>
                ...
                <div className="mt-6 w-80 md:mt-8">
                    ...
                    <div className="flex mt-4 -mx-1.5 ">
                        <a className="mx-1.5 text-black transition-colors duration-300 transform hover:text-[#219ebc]" href="#">
          ...
          <div className="mt-8 lg:w-1/2 lg:mx-6">
            ...
            >
              <h1 className="text-lg font-medium text-black">What do you want to ask</h1>
              ...
              <form className="mt-6" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[rgb(33,157,188)] rounded-md hover:bg-[rgba(33,157,188,0.7)] focus:outline-none focus:ring focus:ring-blue-100 focus:ring-opacity-50"
                >
                  Get in touch
                </button>
              </form>
