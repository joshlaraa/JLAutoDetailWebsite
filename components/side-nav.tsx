    ...
    <div className="md:w-60 bg-white h-screen flex-1 fixed border-r border-zinc-200 hidden md:flex">
      <div className="flex flex-col space-y-6 w-full">
        ...
        >
          ...
          <span className="font-bold text-lg hidden md:flex">LPD Auto Detail</span>
        </Link>
        ...
        <>
          <button
            ...
            className={`flex flex-row items-center p-2 rounded-lg w-full justify-between hover:bg-zinc-100 ${
              isActive ? 'bg-zinc-100 text-[#219ebc]' : 'hover:text-[#219ebc]'
            }`}
          >
              ...
              {item.subMenuItems?.map((subItem, idx) => {
                ...
                return (
                  <Link
                    ...
                    href={subItem.path}
                    className={`${
                      subItemActive ? 'font-bold text-[#219ebc]' : ''
                    }`}
                  >
